...
```{python}
sc.pl.umap(adata, color=["samples", "n_genes", "mt_frac", "doublet_score", "hpv_status", "ir_status"], ncols=2)
```
...
```{python}
sc.pl.umap(adata, color=["n_genes", "n_counts", "mt_frac", "samples", "origin", "leiden", "phase", "doublet_score", "ir_status", "hpv_status"], ncols=2)
```
